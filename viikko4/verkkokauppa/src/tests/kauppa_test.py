...
class TestKauppa(unittest.TestCase):
    ...
    def test_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla_yksi_tuote(self):
    ...
    def test_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla_kaksi_eri_tuotetta(self):

        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(2)
        self.kauppa.tilimaksu("aapo", "95959")

        self.pankki_mock.tilisiirto.assert_called_with("aapo", ANY, "95959", ANY, 12)

    def test_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla_kaksi_samaa_tuotetta(self):
