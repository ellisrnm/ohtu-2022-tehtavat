...
from viitegeneraattori import viitegeneraattori as default_viitegeraattori


class Kauppa:
    def __init__(self, varasto=default_varasto, pankki=default_pankki, viitegen=default_viitegeraattori):
